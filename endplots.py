...
for subject in subjects:
    ...
    for i in range(0,len(ch_names)):
        ...
        plt.title('Subject' + subject_idx + ' '+ ch_name + ' (Event End)')
        plt.xlabel("Time (ms)")
        ...
        for j in range(2):
            ...
            for idx in range(len(start_frame_indices)):
                ...
                ch_go_events_data.append(ch_data[j][end_frame-500:end_frame+250])
        ...
        for j in range(2):
            ...
            for idx in range(len(start_frame_indices)):
                start_frame = start_frame_indices[idx]
                end_frame = end_frame_indices[idx]
                ch_nogo_events_data.append(ch_data[j][end_frame-500:end_frame+250])
